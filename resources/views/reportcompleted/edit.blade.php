        ...
        <div class='col-md-12' >
            ...
            <div class="box box-primary" >
                <div class="box-header with-border text-center">
                    ...
                    <a class="btn close" href="{{ route('report_complete.index') }}"><span aria-hidden="true">×</span></a>
                </div>
                <div class="box-body" >
                    <div class="row">
                    ...
                    <div class="row" >
                      <div class="box-header with-border">
                        ...
                        {!! Form::model($reports, ['method' => 'PATCH','enctype'=>'multipart/form-data','route' => ['report_complete.update', $reports[0]->rpt_id]]) !!}
                          <div class="box-body">
                                    ...
                                    <tbody >
                                      @foreach($record_test as $rec_test)
                                       <tr >
                                           ...
                                           <td>{{$rec_test->r_test_val}}</td>
                                           <td>{{$rec_test->test_unit}}</td>
                                           <td ><textarea  name="r_test_remark[]" class="col-xs-12 col-sm-12 col-md-12">{{$rec_test->r_test_remark}}</textarea></td>
                                        </tr>
                                       @endforeach  
                                    </tbody>
                                </table>
