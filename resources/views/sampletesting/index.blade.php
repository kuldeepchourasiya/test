                    ...
                    <table class="table table-bordered">
                       ...
                       @foreach ($reports as $report)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('sample_testing.edit',$report->rpt_id)}}" class="btn btn-primary">Enter Test value</a> 

                                <a href="{{url('/smpl_tst_proceed/'.$report->rpt_id)}}" class="btn btn-success">Assign Doctor</a> 
                            </td>
