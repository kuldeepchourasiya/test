        ...
        <div class='col-md-12'>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Sample Collection</h3>
                    ...
                    <table class="table table-bordered">
                       ...
                       @foreach ($reports as $report)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('sample_collection.edit',$report->rpt_id)}}" class="btn btn-primary">sample collect</a>
                                <a href="{{url('/sample_proceed/'.$report->rpt_id)}}" class="btn btn-success">Proceed to Testing</a> 
                            </td>
